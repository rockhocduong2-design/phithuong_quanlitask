...
* Yêu cầu hệ thống phải được cài đặt sẵn: VS Code
* Cài các Extension Pack for Java (Bắt buộc):
Language Support for Java™ by Red Hat, Debugger for Java
* Cài Lombok Annotations Support
* Spring Boot Extension Pack (Cực kỳ quan trọng):
...
# Bước 5: Biên dịch và Tải thư viện (Build)
Mở Terminal tại thư mục gốc của dự án và chạy lệnh để Maven tự động tải các thư viện cần thiết:
`mvn clean install`
...
>Lưu ý: Nếu gặp lỗi "Port 8080 is already in use", hãy mở file application.properties và thêm dòng server.port=8081 để đổi cổng.
* Trang danh sách task
![alt text](<Screenshot 2026-04-10 220945(1).png>)

![alt text](<Screenshot 2026-04-10 221951(1).png>)

* form tạo mới task
![alt text](<Screenshot 2026-04-10 222341(1).png>)

* Trang chi tiết task
![alt text](<Screenshot 2026-04-10 223546.png>)